...
| [score-logic](./Implementations/score-logic/phases.md) | 점수 관리 (로직) | [SCRUM-23](https://bimtaeur30.atlassian.net/browse/SCRUM-23) | phase2 구현됨 · 컴파일 확인 대기 | 배치 연동·ScoreChanged·SquareCleared 점수 (턴 리셋·GO는 Phase 3) |
