...
| [random-block-spawn](./Implementations/random-block-spawn/phases.md) | 랜덤 블록 생성 | [SCRUM-18](https://bimtaeur30.atlassian.net/browse/SCRUM-18) | phase2 구현됨 · 확인 대기 | 균등 추첨 로직 완료 |
