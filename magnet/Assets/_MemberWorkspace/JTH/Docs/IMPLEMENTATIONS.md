...
| [score-logic](./Implementations/score-logic/phases.md) | 점수 관리 (로직) | [SCRUM-23](https://bimtaeur30.atlassian.net/browse/SCRUM-23) | phase1 구현됨 · 컴파일 확인 대기 | Domain·ScoreConfigSO (Bootstrap 미연동) |
