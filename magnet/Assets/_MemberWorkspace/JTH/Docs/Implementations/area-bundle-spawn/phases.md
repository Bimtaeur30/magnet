...
- **Area (Phase 8→10):** `base − 4×rectCount − 4×areaCount`, tiny 관대(−15/−8). Unique thresh=**−15**, p=**0.45**. 표: `TUNING_STAGES.md`.
- **Clear Priority (Phase 9→14):** `allClearProbability=0.75`, `allClearCooldownTurns=1`, 멀티 **`hard=6`만**, `outcomeBeamWidth=4`.
