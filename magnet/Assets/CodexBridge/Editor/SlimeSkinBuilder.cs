...
namespace CodexBridge
{
    ...
    public static class SlimeSkinBuilder
    {
        ...
        static void ConfigureSlimeFlow(ParticleSystem particle, ParticleSystemRenderer renderer)
        {
            ...
            var velocity=particle.velocityOverLifetime; velocity.enabled=true; velocity.space=ParticleSystemSimulationSpace.World; velocity.x=new ParticleSystem.MinMaxCurve(-.08f,.08f); velocity.y=new ParticleSystem.MinMaxCurve(-.2f,-.55f); velocity.z=new ParticleSystem.MinMaxCurve(0f,0f);
