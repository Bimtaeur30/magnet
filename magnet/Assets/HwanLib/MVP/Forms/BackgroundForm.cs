...
namespace MVP.Forms
{
    ...
    public class BackgroundForm : AbstractClickForm, IInitializable
    {
        ...
        {
            if (CompleteOnStart && _fadeHandle.IsActive()) _fadeHandle.Complete();
            ...
            _fadeHandle = LMotion.Create(_bgCanvasGroup.alpha, isFadeIn ? 1f : 0f, duration)
                .WithEase(Ease.Linear)
                .WithScheduler(MotionScheduler.UpdateIgnoreTimeScale)
                .WithOnComplete(() => OnFadeEnd?.Invoke(isFadeIn))
                .BindToAlpha(_bgCanvasGroup);
        }
